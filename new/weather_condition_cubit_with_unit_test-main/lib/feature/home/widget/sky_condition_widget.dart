    ...
    switch (skyCondition) {
      case SkyCondition.clear:
        if (DateTime.now().compareTo(sunSet!) > 0) {
          return Column(children: [
            Lottie.asset("assets/animations/night.json",
                width: 130, height: 130),
            const Text(
              "CLEAR",
              style: TextStyle(
                  color: ColorConstants.skyConditionGreenColor,
                  fontSize: 16,
          ...
          return Column(children: [
            Lottie.asset("assets/animations/clear.json",
                width: 130, height: 130),
            const Text(
              "Clear",
              style: TextStyle(
      ...
      case SkyCondition.fewClouds:
        if (DateTime.now().compareTo(sunSet!) > 0) {
          ...
          return Column(children: [
            Lottie.asset("assets/animations/few_clouds.json",
                width: 130, height: 130),
            const Text(
              "Few Clouds",
              style: TextStyle(
